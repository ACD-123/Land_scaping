                    ...
                    <form id="msform">
                        ...
                        <fieldset class="my-first-field">
                            ...
                            <div class="row provider-gradedetails">
                                ...
                                <p style="width: 100%;">I have 10+ years experience in vehicle mechanics and have my own equipment, I would <br>
                            ...
                            <div class="row booking-section" style="width: 100%;">
                                ...
                                <div class="upload-field-booking">
                                 ...
                                 <label style="background-image: url(./images/providerselected/upload.PNG);">
                                  ...
                                  <p style="text-align: left;">Minimum 5 images of Of your service area , make sure image should be clear</p>
                                </div>
                                    ...
                                    <div id='main'>
                                     ...
                                     <div class="row advnce" style="padding: 60px 0px;">
                                        <div class="advancebooking-calender">
                                          ...
                                          <div class="innerrow" style="margin-top: 30px; background-color: #ffc4006e                                          ;">
                                            <div class="col-lg-6 mb-6 mb-lg-0 align-items-center">
                                              <h1> <img src="./images/calender.png"/>29-June-2023 , MON</h1> 
                                            </div>
                                            <div class="col-lg-6 mb-6 mb-lg-0" style="text-align:right;">
                          ...
                          <div class="your-offer-selected advanceoffer">
                            ...
                            <div class="row advance-offer-new">
                                ...
                                <div class="unorderlist-selected">
                                  ...
                                  <li><em><img src="./images/providerselected/Snow Plow.png"/>Snow Removal</em><span>$100.00</span></li>
                                  <li><em><img src="./images/providerselected/Cover Up.png"/>Spring Cleanup</em><span>$100.00</span></li>
                                  <li><em><img src="./images/providerselected/Grass.png"/>Grass Cutting</em><span>$100.00</span></li>
                                </div>
                              ...
                              <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="advancebookedtimings">
                                  <ul>
                                    <li style="background-color: #70BE4442;"><em>29-June-2023 , MON</em> <span>10 am -12 am</span></li>
                                    <li style="background-color: #FCE2E2;"><em>29-June-2023 , MON</em> <span>10 am -12 am</span></li>
                                    <li style="background-color: #FFEEB5;"><em>29-June-2023 , MON</em> <span>10 am -12 am</span></li>
                                  </ul>
                                </div>
                              </div>
                             ...
                             <input type="button" name="next" class="submit next action-button" value="Proceed & Send Request to Provider" />
                              <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                        </fieldset>
                        <fieldset>
