...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="shop-working-days" style="padding: 50px 0px;">
        <div class="headingsec">
            <div class="row">
                <div class="col-md-6">
                    <h2>Set your shop working days/timings</h2>
                </div>
        ...
        <div class="table-working-days-time">
            
            <div class="row">
                <div class="col-md-3">
                    <h3 style="padding-bottom: 10px;">Status</h3>
                    <select name="status" id="statuss">
                        <option value="Work Day">Work Day</option>
                        <option value="Work Day">Off Day</option>
                      </select>
                </div>
                <div class="col-md-3">
                    <h3 style="padding-bottom: 10px;">Day</h3>
                ...
                <div class="col-md-3">
                    <h3 style="padding-bottom: 10px;">Open time</h3>
                    <input type="text" class="time-pickable" readonly>
                </div>
                <div class="col-md-3">
                    <h3 style="padding-bottom: 10px;">Close time</h3>
                    <input type="text" class="time-pickable" readonly>
      ...
      <div class="next-previouss">
        <div class="row">
            <div class="col-md-6">
          <a href="service-provider-home.php">Back</a>
        </div>
        <div class="col-md-6">
            <a style="float: right;" href="service-provider-home3.php">Next</a>
          </div>
        </div>
      </div>
