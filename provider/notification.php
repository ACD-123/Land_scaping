...
<section id="notifications-main">
    ...
    global $conn;
    $sql = "SELECT messages.message_content, messages.customer_id, provider_registration.fullname, provider_registration.profile_picture FROM messages
            INNER JOIN provider_registration ON messages.customer_id = provider_registration.id
            WHERE messages.provider_id = ? AND messages.status = 'customer_send'";
